                            ...
                            <div className="mt-2 p-3 bg-orange-50/50 border border-orange-100 rounded-xl space-y-3">
                              ...
                              <div className="flex flex-wrap gap-2">
                                <button
                                  ...
                                  className="px-4 py-2 bg-emerald-500 text-white text-xs font-black rounded-lg hover:bg-emerald-600 transition-colors shadow-sm"
                                >
                                  ✓ Confirmar sugerencia
                                </button>
                                <button
                                  onClick={() => setShowSearchBox(prev => ({ ...prev, [r.rowKey]: true }))}
                                ...
                                <button
                                  onClick={() => setQuickCreateForms(prev => ({ ...prev, [r.rowKey]: { name: r.nameInText, rut: '', club: '', category: r.category || selectedCategory, saving: false } }))}
                                  className="px-4 py-2 bg-white border border-slate-200 text-slate-600 text-xs font-bold rounded-lg hover:bg-slate-50 transition-colors shadow-sm"
                                >
                                  Crear nuevo
                                </button>
