...
export default function AdminNav() {
  ...
  const navItems = [
    ...
    // ✅ NUEVO BOTÓN DE EVENTOS / FORMULARIOS
    {
      name: 'Eventos',
      path: '/admin/events',
      icon: (active: boolean) => (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill={active ? "currentColor" : "none"} viewBox="0 0 24 24" stroke="currentColor" strokeWidth={active ? 2.5 : 1.8}><path strokeLinecap="round" strokeLinejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>
      )
    },
    {
      name: 'Riders',
  ...
  return (
    <>
      ...
      <div className="fixed bottom-0 left-0 w-full z-50 px-4 pb-8 pt-2">
        <div className="max-w-2xl mx-auto bg-[#1A1816] rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.5)] border border-white/10 flex justify-around items-center py-5 px-3 backdrop-blur-2xl bg-opacity-95">
                ...
                return (
                    <Link 
                        ...
                        className={`flex flex-col items-center gap-1.5 transition-all duration-300 flex-1 ${
                            active 
                            ? 'text-[#FFD700]' // Ajustado al color dorado para que coincida si usas chaski-gold
            ...
            <Link href="/ranking" className="flex flex-col items-center gap-1.5 text-[#C64928] hover:text-red-500 transition-all px-4 group">
